...
* **strictVersionValidation** : If this is set to `true` all version warnings from the plugin will be turned in errors and fail the build. The property `aem.analyser.strict.version` can be used to set this from the commandline.
